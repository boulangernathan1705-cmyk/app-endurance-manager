...
const EN=new Map(Object.entries({
  ...
  'Choisis ta communauté':'Choose your community','Choisis ton simulateur':'Choose your simulator','1 · ESPACE':'1 · SPACE','2 · SIMULATEUR':'2 · SIMULATOR','ESPACE CHOISI':'SELECTED SPACE','← Changer de communauté':'← Change community','Espaces disponibles':'Available spaces','Chargement de tes espaces…':'Loading your spaces…','Endurance Manager · Général':'Endurance Manager · General','Endurances indépendantes':'Independent endurance events','Communauté par défaut':'Default community','Communauté publique':'Public community','Membre':'Member','Gérer ou découvrir des communautés':'Manage or discover communities','Simulateurs disponibles':'Available simulators','Chargement de la prochaine endurance…':'Loading the next endurance event…',
  'Nommer organisateur':'Make organizer','Retirer organisateur':'Remove organizer role','Rôle organisateur du site':'Site organizer role','Aucun rôle organisateur':'No organizer role',
  'Synchroniser automatiquement les membres et organisateurs':'Automatically sync members and organizers','Webhook du salon récapitulatif':'Summary channel webhook','Supprimer le webhook actuel':'Remove the current webhook','Simulateur du récapitulatif':'Summary simulator','Enregistrer la synchronisation':'Save synchronization','Membres synchronisés':'Members synchronized','Synchronisation désactivée':'Synchronization disabled',
  'Discord peut fournir l’identité visuelle, synchroniser les membres et organisateurs, puis publier le récapitulatif des courses.':'Discord can provide the visual identity, synchronize members and organizers, and publish the race summary.',
