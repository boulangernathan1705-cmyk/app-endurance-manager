...
const EN=new Map(Object.entries({
  ...
  'engagé':'entered','engagés':'entered','ÉQUIPAGE COMPLET':'CREW COMPLETE','Places libres':'Open seats','Ton équipage':'Your crew','Aucun équipage pour l’instant':'No crew yet','Tu es inscrit sur ce départ':'You are registered for this start','Date à confirmer':'Date to be confirmed','Responsable':'Owner','Aucun pilote':'No driver','ÉQUIPAGE OUVERT':'CREW OPEN','Équipage complet':'Crew complete','Équipage ouvert':'Crew open','Ouvert':'Open','Complet':'Complete',
