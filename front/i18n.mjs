...
const EN=new Map(Object.entries({
  ...
  'Rechercher un pilote…':'Search a driver…','Rechercher un membre':'Search a member','Enregistrement…':'Saving…','✓ Enregistré':'✓ Saved','Aucun membre ne correspond à cette recherche.':'No member matches this search.','Commun à LMU et iRacing. Un pilote apparaît ici après sa première connexion Discord ; son rôle est enregistré dès que tu le changes.':'Shared by LMU and iRacing. A driver appears here after their first Discord sign-in; their role is saved as soon as you change it.','Gestion des membres':'Member management','Administrateur principal':'Main administrator','Organisateur':'Organizer',
