...
const EN=new Map(Object.entries({
  ...
  'Copier le lien':'Copy link','Lien copié':'Link copied','Copier le lien de la course':'Copy race link','Lien copié ✓':'Link copied ✓','Horaires à confirmer':'Schedule to be confirmed','Affiche l’étiquette « Horaires à confirmer » tant que les dates et heures peuvent encore changer.':'Shows the “Schedule to be confirmed” label while dates and times may still change.','Ton inscription':'Your entry','Pilote et catégorie':'Driver and category','Modifier ton inscription':'Edit your entry','PILOTE':'DRIVER','Cette course n’est plus disponible.':'This race is no longer available.','Copie le lien de la course :':'Copy the race link:','Masquer':'Hide','Filtrer les événements':'Filter events','Aucun événement à venir.':'No upcoming events.','Aucun événement archivé.':'No archived events.',
