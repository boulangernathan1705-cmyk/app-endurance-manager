...
const EN=new Map(Object.entries({
  ...
  'engagé':'entered','engagés':'entered','ÉQUIPAGE COMPLET':'CREW COMPLETE','Places libres':'Open seats','Ton équipage':'Your crew','Responsable':'Owner','Aucun pilote':'No driver','ÉQUIPAGE OUVERT':'CREW OPEN','Équipage complet':'Crew complete','Équipage ouvert':'Crew open','Ouvert':'Open','Complet':'Complete',
