...
import {scopeEvent,organizationContextMarkup} from './organization-context.mjs?v=1';
...
export function renderNav(){nav.innerHTML=`${button('home','Événements')}${button('my-entries','Mes inscriptions')}${state.user?'<button type="button" class="secondary-button" data-organizations-open>Team & communautés</button>':''}<div class="nav-game-switcher" aria-label="Changer de simulateur"><a class="nav-game-switcher-button nav-game-switcher-lmu" href="/lmu/">Le Mans Ultimate</a><a class="nav-game-switcher-button nav-game-switcher-iracing" href="/iracing/">iRacing</a></div>`;notifyNav();}
