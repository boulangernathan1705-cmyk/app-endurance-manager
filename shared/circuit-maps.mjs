...
export const CIRCUIT_MAPS = Object.freeze({
  ...
  cota:{file:'Austin Formula One circuit (2).svg',scale:0.82,mobileScale:1.12,mobileX:-2,mobileY:0},
  ...
  'le-mans':{file:'Circuit de la Sarthe.svg',scale:0.74,mobileScale:1.16,mobileX:0,mobileY:0},
