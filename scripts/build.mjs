...
for(const file of ['index.html','styles.css','app.js','crew-accordion.css','crew-accordion.js','crew-builder.css','crew-builder.js','ux-refinement.css','ux-refinement.js','help.css','help.js']) await copyFile(root+file,new URL(file,out));
